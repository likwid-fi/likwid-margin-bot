...
export interface PancakeswapQuoterV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH9"
      | "deployer"
...
export interface PancakeswapQuoterV2 extends BaseContract {
  connect(runner?: ContractRunner | null): PancakeswapQuoterV2;
  waitForDeployment(): Promise<this>;

  interface: PancakeswapQuoterV2Interface;
